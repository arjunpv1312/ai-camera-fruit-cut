...
export const WEAPON_CATALOG: Record<WeaponType, WeaponInfo> = {
  katana: {
    ...
    name: 'Dual Katanas',
    emoji: '⚔️',
    description: 'Precision air edge slicing with energy blade trails',
  ...
  hammer: {
    ...
    name: 'Thunder Hammer',
    emoji: '🔨',
    description: 'Hand slam sends electrical shockwaves shattering all fruits nearby!',
  ...
  laser: {
    ...
    name: 'Plasma Cannon',
    emoji: '🔫',
    description: 'Open palm gesture shoots instant energy laser beams!',
  ...
  frost: {
    ...
    name: 'Frost Gauntlet',
    emoji: '❄️',
    description: 'Freeze flying fruits in mid-air, then shatter into ice crystals!',
  ...
  vortex: {
    ...
    name: 'Gravity Vortex',
    emoji: '🌌',
    description: 'Clench hand into a fist to pull all fruits into a black hole!',
